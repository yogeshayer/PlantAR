...
struct TeacherLoginView: View {
    ...
    var isFormValid: Bool {
        ...
        return emailLower.contains("@") && (emailLower.hasSuffix(".edu") || emailLower.contains("school"))
    }
        ...
        ScrollView {
            VStack(spacing: PlantSpacing.xxl) {
                ...
                VStack(alignment: .leading, spacing: PlantSpacing.sm) {
                    ...
                    Text("Must be a valid school email address (.edu domain)")
                        .font(.caption)
                        .foregroundColor(.textTertiary)
                }
    ...
    private func handleLogin() {
        ...
        Task {
            do {
                try await teacherAuth.authenticateTeacher(email: email.trimmingCharacters(in: .whitespaces))
            } catch {
